...
| --- | --- | --- |
| /leads | POST | ✅ |
| /leads | GET (paginado + filtros) | ✅ |
| /leads/:id | GET | ✅ |
| /leads/:id | PATCH | ✅ |
| /leads/:id | DELETE (soft delete) | ✅ |
| /leads/stats | GET | ✅ |
| /leads/ai/summary | GET | ✅ |

## Extras implementados:

*   ✅ Seed con 12 leads
*   ✅ Tests unitarios (4 tests pasando)
...
DATABASE\_URL="postgresql://user:password@localhost:5432/one\_million\_copy?schema=public"  
PORT=3000
